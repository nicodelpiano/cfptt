...
(*
  Tome esta definicion de isRW diferente para no complicarla tanto
  en las definiciones de Pre y Post (tampoco seria tan distinto cambiarla
  a como esta especificada en el paper).
  Simplemente toma diferentes argumentos que tenemos en el scope en Pre y Post
  para hacer una definicion mas limpia que cumple la especificacion.
*)
